...
func LoadRuntime(path string) (Runtime, error) {
	...
	runtime, err := parseRuntime(raw.Runtime.LeaseTTL, raw.Runtime.LeaseRenewInterval, raw.Runtime.SQLiteBusyTimeout)
	if err != nil {
...
func parseRuntime(leaseTTL, leaseRenewInterval, sqliteBusyTimeout string) (Runtime, error) {
